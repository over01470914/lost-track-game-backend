...
# 模拟数据池
PAGES = [
    "/home", "/products", "/products/detail/123", 
    "/cart", "/checkout", "/login", "/profile", "/about"
]
...
TARGETS = [
    ...
    "title_social-twitter", "title_social-facebook", "title_social-instagram", "title_social-youtube",
    "title_background-top", "title_game-content", "title_about-us","title_news"
]
    ...
    for i in range(TOTAL_REQUESTS):
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                # 打印进度条
                if i % 50 == 0:
                    print(f"进度: {i}/{TOTAL_REQUESTS} ({fake_time.strftime('%Y-%m-%d %H:%M')})")
        except Exception as e:
